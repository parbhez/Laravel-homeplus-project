						...
						<div class="tab-content">
						    ...
						    <div role="tabpanel" class="tab-pane table-responsive" id="addProduct">
				                ...
				                <div class="form-group">
				                    ...
				                    <div class="col-md-8">
				                    	<textarea class="form-control" name="product_details_bn" id="address" placeholder="আলাদা লাইন এর জন্য  #  ব্যাবহার  করুন  "><?php echo e(old('product_details_bn')); ?></textarea>
				                    </div>
				                </div>
				                <div class="form-group">
				                    <label class="col-md-2">Product Details Bn </label>
				                    <div class="col-md-8">
				                    	<textarea class="form-control" name="product_details_en" id="address" placeholder="আলাদা লাইন এর জন্য  #  ব্যাবহার  করুন  "><?php echo e(old('product_details_en')); ?></textarea>
				                    </div>
				                </div>
				            	<div class="form-group">
