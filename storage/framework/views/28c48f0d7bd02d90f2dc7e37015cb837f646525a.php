					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<div class="tab-content">
						    <div role="tabpanel" class="tab-pane active" id="productDetails">
						   		<?php echo Form::open(array('route'=>'editProductDetails.post','class'=>'form-horizontal form-wrp productDetailsForm','files'=>true)); ?>

						   			<input type="hidden" name="product_id" value="<?php echo e($product['product']->product_id); ?>">
						   			<div class="form-group">
										...
										<div class="col-md-3">
											<select class="form-control" id="category_select" name="category_name_id" >
												<?php if(isset($categories)): ?>
													...
													<option value="<?php echo e($category->id); ?>" <?php if($product['product']->category_id == $category->id): ?>selected <?php endif; ?> ><?php echo e($category->category_name_lang1); ?></option>
													<?php endforeach; ?>
												<?php endif; ?>
											</select>
										</div>
										...
										<div class="col-md-3">
											<span class='loader' style="display:none;"><img src="<?php echo e(URL::to('public/icons/ajax-loader.gif')); ?>" alt="loading"></span>  
											<select class="form-control" id="sub_category_select" name="sub_category_name_id">
												<option value="<?php echo e($product['product']->sub_category_id); ?>"><?php echo e($product['product']->sub_category_name_lang1); ?></option>
											</select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-3">
											<span class='loader1' style="display:none;"><img src="<?php echo e(URL::to('public/icons/ajax-loader.gif')); ?>" alt="loading"></span>  
											<select class="form-control" id="sub_category_details_select" name="sub_sub_category_name_id">
												<option value="<?php echo e($product['product']->sub_sub_category_id); ?>"><?php echo e($product['product']->sub_sub_category_name_lang1); ?></option>
											</select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<input type="text" class="form-control" name="product_name_lang1" value="<?php echo e($product['product']->product_name_lang1); ?>">
										</div>
										<label class="col-md-2"> Product Name Bangla </label>
										<div class="col-md-3">
											<input type="text" class="form-control" name="product_name_lang2" value="<?php echo e($product['product']->product_name_lang2); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2"> Market Price</label>
										<div class="col-md-3">
											<input type="number" id="market_price" class="form-control market_price_discount" name="market_price" value="<?php echo e($product['product']->market_price); ?>">
										</div>
										<label class="col-md-2"> Discount </label>
										<div class="col-md-3">
											<input type="number" id="discount" class="form-control market_price_discount" name="discount" value="<?php echo e($product['product']->discount); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2">Sale Price </label>
										<div class="col-md-3">
											<input type="number" class="form-control product_sale_price" name="sale_price" value="<?php echo e($product['product']->sale_price); ?>">
										</div>
										<label class="col-md-2"> Commission (%)</label>
										<div class="col-md-3">
											<input type="number" class="form-control product_commission" name="commission" value="<?php echo e($product['product']->commission); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2"> E-shopping Commission </label>
										<div class="col-md-3">
											<input type="text" class="form-control eshopping_commission" name="commission_amount" value="<?php echo e(($product['product']->sale_price * $product['product']->commission)/100); ?>">
										</div>
										<label class="col-md-2"> Quantity </label>
										<div class="col-md-3">
											<input type="number" class="form-control" name="quantity" value="<?php echo e($product['product']->quantity); ?>">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2"> Product Details Bangla </label>
										<div class="col-md-8">
											<textarea rows="3" class="form-control" name="details_lang1"><?php echo e($product['product']->details_lang1); ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2"> Product Details English </label>
										<div class="col-md-8">
											<textarea rows="3" class="form-control" name="details_lang2"><?php echo e($product['product']->details_lang2); ?></textarea>
										</div>
									</div>
									<div class="form-group">
						    ...
						    <div role="tabpanel" class="tab-pane" id="ProductProperties">
						    	<?php echo Form::open(array('route'=>'editProductProperties.post','class'=>'form-horizontal form-wrp productPropertiesForm','files'=>true)); ?>
											...
											<select class="form-control chosen-select" id="" name="color_id[]" data-placeholder="Select Color" multiple tabindex="6">
												<?php if(isset($colors)): ?>
													<?php foreach($colors as $color): ?>
														<?php $flag = 0; ?>
													<?php foreach($product['colors'] as $selectedColor): ?>
															<?php if($selectedColor->color_id == $color->id): ?>
																<option value="<?php echo e($color->id); ?>" selected><?php echo e($color->color_name_lang1); ?></option>
																<?php $flag = 1; break; ?>
															<?php endif; ?>
														<?php endforeach; ?>
														<?php if($flag == 0): ?>
															<option value="<?php echo e($color->id); ?>"><?php echo e($color->color_name_lang1); ?></option>
														<?php endif; ?>
													<?php endforeach; ?>
												<?php endif; ?>
											</select>
											...
											<select class="form-control chosen-select" id="" name="size_id[]" data-placeholder="Seelect Size" multiple tabindex="6">
												<?php if(isset($sizes)): ?>
													<?php foreach($sizes as $size): ?>
														<?php $flag = 0; ?>
														<?php foreach($product['sizes'] as $selectedSizes): ?>
															<?php if($selectedSizes->size_id == $size->id): ?>
																<option value="<?php echo e($size->id); ?>" selected><?php echo e($size->size_title_lang1); ?></option>
																<?php $flag = 1; break; ?>
															<?php endif; ?>
														<?php endforeach; ?>
														<?php if($flag == 0): ?>
															<option value="<?php echo e($size->id); ?>"><?php echo e($size->size_title_lang1); ?></option>
														<?php endif; ?>
													<?php endforeach; ?>
												<?php endif; ?>
											</select>
						    		...
						    		<?php if(isset($product['images'])): ?>
										<?php foreach($product['images'] as $productImage): ?>
											<div class="col-md-2" style="padding-bottom: 40px" >
											    <div class="removeImage" id="removeImage_<?php echo e($productImage->id); ?>" data-type="<?php echo e($productImage->type); ?>" data-path="<?php echo e($productImage->path); ?>">
												    <a href="">
												     	<i class="fa fa-remove " style="z-index: 11; float:right; margin-right:25px; margin-bottom: -40px"> </i>
												    </a>
												    
											     </div>
											     <a href="<?php echo e(URL::to('/public/images/product').'/'.$productImage->path); ?>" class="fa fa-download" download> Download</a>
											    <div> 
												   <img src="<?php echo e(URL::to('/public/images/product').'/'.$productImage->path); ?>" width="150" height="150">
											    </div>
											</div>
										<?php endforeach; ?>
									<?php endif; ?>
						    	</div>
						    	<?php echo Form::open(array('route'=>'editProductImage.post','class'=>'form-horizontal form-wrp productImageForm','files'=>true)); ?>

						   			<input type="hidden" name="product_id" value="<?php echo e($product['product']->product_id); ?>">
						   			<input type="hidden" name="merchant_id" value="<?php echo e($product['product']->fk_merchant_id); ?>">
						   			<div class="form-group">
...
//======@@ Get Categroy Wise SubCategory @@======
	$("#sub_category_select").on('change',function(e){
		...
		$.ajax({
                url: '<?php echo e(URL::to('getSubCategoryWiseSubCategoryDetails')); ?>/' + subCategoryId ,
                processData: false,
                contentType: false,
                beforeSend: function() {
                    loader.show();
	...
	$('.removeImage').on('click',function(e){
		...
		$.ajax({
		  	url: "<?php echo e(URL::to('removeImage')); ?>",
		  	dataType:'json',
