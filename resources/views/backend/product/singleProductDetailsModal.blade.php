    ...
    <div class="row">
        <div class="col-md-12" style="">
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->company_name}}</label>
                </div>

                <label class="col-md-2"> Product Code :</label>
                <div class="col-md-4">
                    <label>{{$products->product_code}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->category_name_lang1}}</label>
                </div>

                <label class="col-md-2"> Category Name Bangla :</label>
                <div class="col-md-4">
                    <label>{{$products->category_name_lang2}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->sub_category_name_lang1}}</label>
                </div>

                <label class="col-md-2"> Sub Category Name Bangla :</label>
                <div class="col-md-4">
                    <label>{{$products->sub_category_name_lang2}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->sub_sub_category_name_lang1}}</label>
                </div>

                <label class="col-md-2"> Sub Sub Category Name Bangla :</label>
                <div class="col-md-4">
                    <label>{{$products->sub_sub_category_name_lang2}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->product_name_lang1}}</label>
                </div>

                <label class="col-md-2"> Product Name Bangla :</label>
                <div class="col-md-4">
                    <label>{{$products->product_name_lang2}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->details_lang1}}</label>
                </div>
                <label class="col-md-2"> Product Details English :</label>
                <div class="col-md-4">
                    <label>{{$products->details_lang2}}</label>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->market_price}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{$products->sale_price}}</label>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-4">
                    <label>{{(($products->market_price - $products->discount) * $products->commission)/100}}</label>
                </div>
