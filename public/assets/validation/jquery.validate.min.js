...
(function(c) {
    c.extend(c.fn, {
        ...
        rules: function(a, b) {
            ...
            d.required && (e = d.required, delete d.required, d = c.extend({
                required: e
            }, d));
            return d
        }
    ...
    c.extend(c.validator, {
        ...
        prototype: {
            ...
            check: function(a) {
                ...
                for (g in b) {
                    ...
                    try {
                        if (f = c.validator.methods[g].call(this, e, a, h.parameters), "dependency-mismatch" === f) d = !0;
                        else {
                            d = !1;
                            if ("pending" === f) {
            ...
            showLabel: function(a, b) {
                ...
                d.length ? (d.removeClass(this.settings.validClass).addClass(this.settings.errorClass), d.attr("generated") && d.html(b)) : (d = c("<" + this.settings.errorElement + "/>").attr({
                    "for": this.idOrName(a),
                    generated: !0
                }).addClass(this.settings.errorClass).html(b || ""), this.settings.wrapper && (d = d.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.append(d).length || (this.settings.errorPlacement ? this.settings.errorPlacement(d, c(a)) : d.insertAfter(a)));
        ...
        normalizeRules: function(a, b) {
            ...
            if (c.validator.autoCreateRanges && (a.min && a.max && (a.range = [a.min, a.max], delete a.min, delete a.max), a.minlength && a.maxlength)) a.rangelength = [a.minlength, a.maxlength], delete a.minlength, delete a.maxlength;
