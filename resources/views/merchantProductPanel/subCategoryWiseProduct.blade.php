...
@section('main_container')
                ...
                <div class="row">
                    <div class="col-md-12">
                        @if(count($subCategory) > 0)
                            <img style="display: none" src="{{URL::to('public/images/subCategory').'/'.$subCategory->featured_image}}" alt="">
                        @endif
                    </div>
                </div>
            </div>
                        ...
                        <div class="product_title_and_list">
                            ...
                            <div class="sub_category_list">
                                <ul class="list-inline">
                                    <li>
                                        <p>{{trans('frontend.sub_category')}}</p>
                                    </li>
    ...
    <script>
        ...
        function loadContent(subSubCategoryId,startRange,endRange) {
            var subCategoryId = "@if(isset($subCategory)){{$subCategory->id}}@endif";
            ...
            $.ajax({
                url  : "{{URL::to('merchantSubCategoryWiseProductLoad')}}",
                type : 'GET',
                dataType : 'json',
