...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(URL::to('public/merchantCorner/assets/img/favicon-32x32.png')); ?>">
    <title>Marcent Corner</title>

    <!-- Font Awesome CSS-->
    <?php echo HTML::style('public/merchantCorner/assets/css/font-awesome.min.css'); ?>

    <?php echo HTML::style('public/merchantCorner/assets/css/solaiman-lipi.css'); ?>

            <!-- Bootstrap CSS-->
    <?php echo HTML::style('public/merchantCorner/assets/css/bootstrap.min.css'); ?>

            <!-- Owl Carousel CSS-->
    <?php echo HTML::style('public/merchantCorner/assets/css/owl.carousel.css'); ?>

            <!-- Custom CSS-->
    <?php echo HTML::style('public/merchantCorner/assets/style.css'); ?>

    <?php echo HTML::style('public/merchantCorner/assets/css/marcent-corner.css'); ?>

            <!-- Responsive CSS-->
    <?php echo HTML::style('public/merchantCorner/assets/css/responsive.css'); ?>
    ...
    <!--[if lt IE 9]>
    <?php echo HTML::script('public/frontend/assets/js/html5shiv.min.js'); ?>

    <?php echo HTML::script('public/frontend/assets/js/respond.min.js'); ?>

    <![endif]-->

    <!-- jQuery -->
    <?php echo HTML::script('public/frontend/assets/js/jQuery v1.12.4.js'); ?>

            <!-- Bootstrap JS -->
    <?php echo HTML::script('public/frontend/assets/js/bootstrap.min.js'); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="<?php echo e(URL::to('/')); ?>" class="logo">
                    <img src="<?php echo e(URL::to('public/merchantCorner/assets/img/logo.png')); ?>" alt="">
                </a>
            </div>
            <!--Close Logo-->
            ...
            <div class="col-md-6">
                <div class="marcent_login">
                    ...
                    <?php echo Form::open(['route'=>'merchantLogin','class'=>'form-inline','id'=>'merchantLoginForm']); ?>

                        <div class="form-group">
                            <input type="email" class="form-control" id="exampleInputEmail2" name="email" placeholder="<?php echo e(trans('frontend.email')); ?>">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" id="exampleInputName2" name="password" placeholder="<?php echo e(trans('frontend.password')); ?>">
                        </div>
                        <button type="submit" class="btn btn-default"><?php echo e(trans('frontend.signin')); ?></button>
                    <?php echo Form::close(); ?>

                    <a href="<?php echo e(URL::to('merchantForgotPassword')); ?>" style="font-size: 16px; line-height: 40px;">Forgot Password ?</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="faq_and_signup">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <?php echo $__env->make('merchantCorner.errors.messages', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            </div>
            ...
            <div class="col-md-4">
                <div class="marcent_sign_up">
                    <h2>Sign Up Here</h2>
                    <?php echo Form::open(['route'=>'merchantPage.post','class'=>'','id'=>'marcentRegistrationForm']); ?>

                        <div class="form-group">
                            <label for="name"><?php echo e(trans('frontend.name')); ?></label>
                        ...
                        <div class="form-group">
                            <label for="password"><?php echo e(trans('frontend.password')); ?></label>
                            <input type="password" class="form-control" id="password" name="password" placeholder="Password">
                        </div>
                        <div class="form-group">
                            <label for="phone"><?php echo e(trans('frontend.mobile_no')); ?></label>
                            <input type="text" class="form-control" id="phone" name="mobile_no" placeholder="Phone">
                        </div>
                        <div class="form-group">
                            <label for="company-name"><?php echo e(trans('frontend.company_name')); ?></label>
                            <input type="text" class="form-control" id="company-name" name="company_name" placeholder="Company Name">
                        </div>
                        <div class="form-group">
                            <label for="address"><?php echo e(trans('frontend.address')); ?></label>
                            <textarea class="form-control" id="address" name="address" placeholder="Your Address"></textarea>
                        </div>
                        
                        <button type="submit" class="btn btn-default" style="margin-top: 30px;"><?php echo e(trans('frontend.register')); ?></button>
                    <?php echo Form::close(); ?>
        ...
        <div class="row">
            <div class="col-md-3">
                <a href="" class="single_quick_link">
                    ...
                    <h2><?php echo e(trans('frontend.registration')); ?></h2>
                </a>
            </div>
            <div class="col-md-3">
                <a href="" class="single_quick_link">
                    <i class="fa fa-list-alt"></i>
                    <h2><?php echo e(trans('frontend.product_listing')); ?></h2>
                </a>
            </div>
            <div class="col-md-3">
                <a href="" class="single_quick_link">
                    <i class="fa fa-car"></i>
                    <h2><?php echo e(trans('frontend.product_delivery')); ?></h2>
                </a>
            </div>
            <div class="col-md-3">
                <a href="" class="single_quick_link">
                    <i class="fa fa-money"></i>
                    <h2><?php echo e(trans('frontend.payment_receive')); ?></h2>
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="footer_content">
                    ...
                    <ul class="footer_list">
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#footer-how-to-order')); ?>" target="_blank">How to Order</a>
                        </li>
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#footer-refund-policy')); ?>" target="_blank">Return Policy</a>
                        </li>
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#footer-shipment')); ?>" target="_blank">Shipment</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="footer_content">
                    ...
                    <ul class="footer_list">
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#footer-contact-us')); ?>" target="_blank">Contact Us</a>
                        </li>
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#footer-about-seller')); ?>" target="_blank">About Seller</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="footer_content">
                    ...
                    <ul class="footer_list">
                        ...
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#')); ?>" target="_blank">Google Plus</a>
                        </li>
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#')); ?>" target="_blank">Twitter</a>
                        </li>
                        <li>
                            <a href="<?php echo e(URL::to('footerMenuDetails#')); ?>" target="_blank">Youtube</a>
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- Owl Carousel CSS-->
<?php echo HTML::script('public/merchantCorner/assets/js/owl.carousel.min.js'); ?>

<!--Opacity & Other IE fix for older browser-->
<!--[if lte IE 8]>
<?php echo HTML::script('public/merchantCorner/assets/js/ie-opacity-polyfill.js'); ?>

<![endif]-->

<!-- Custom JS -->
<?php echo HTML::script('public/merchantCorner/assets/js/custom.js'); ?>
