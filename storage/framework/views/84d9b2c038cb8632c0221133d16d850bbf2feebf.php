            ...
            <div class="row">
                <div class="col-md-12">
                    <?php if(count($category) > 0): ?>
                        <img src="<?php echo e(URL::to('public/images/category/featured_image').'/'.$category->featured_image); ?>" alt="">
                    <?php endif; ?>
                </div>
            </div>
        </div>
                    ...
                    <div class="product_title_and_list">
                        ...
                        <div class="sub_category_list">
                            <ul class="list-inline">
                                <li>
                                    <p><?php echo e(trans('frontend.category')); ?></p>
                                </li>
                                <?php if(isset($subCategories)): ?>
                                    <?php foreach($subCategories as $subCategory): ?>
                                        <li>
                                            <a class="sub_category" id="subCategory_<?php echo e($subCategory->id); ?>" data-status="0">
                                                <?php if(Session::get('frontend_lang') == 1): ?>
                                                    <?php echo e($subCategory->sub_category_name_lang1); ?>

                                                <?php else: ?>
                                                    <?php echo e($subCategory->sub_category_name_lang2); ?>
...
<script>
    ...
    function loadContent(subCategoryId,startRange,endRange) {
        var categoryId = "<?php if(isset($category)): ?><?php echo e($category->id); ?><?php endif; ?>";
        if (!categoryId){
        ...
        $.ajax({
            url  : "<?php echo e(URL::to('categoryWiseProductLoad')); ?>",
            type : 'GET',
            dataType : 'json',
