					...
					<!-- =======Start Page Content======= -->
						...
						<div class="tab-content">
									...
									<tbody>
										...
										<?php if(isset($cities)): ?>
											...
											<tr>
												...
												<td class="">
													<span><?php echo e($city->city_name_lang1); ?></span>
													<input id="cityNameEn<?php echo e($city->id); ?>" class=" form-control col-md-1 input-sm" required style="display: none;" type="text" name="city_name_lang1" value="<?php echo e($city->city_name_lang1); ?>" />
												</td>
												<td class="">
													<span><?php echo e($city->city_name_lang2); ?></span>
													<input id="cityNameBn<?php echo e($city->id); ?>" class=" form-control col-md-1 input-sm" required style="display: none;" type="text" name="city_name_lang2" value="<?php echo e($city->city_name_lang2); ?>" />
												</td>
												<td class="">
													<span><?php echo e($city->cost); ?></span>
													<input id="cityWiseCost<?php echo e($city->id); ?>" class=" form-control col-md-1 input-sm" required style="display: none;" type="text" name="city_wise_cost" value="<?php echo e($city->cost); ?>" />
												</td>
												<td class="">
						    					...
						    					<td>
						        					<a href="javascript:;" class="btn-edit btn btn-primary btn-xs" id="editTitle_<?php echo e($city->id); ?>"><i class="fa fa-edit">&nbsp;<?php echo e(trans('common.edit')); ?></i></a>
						        					<a href="javascript:;" style="display:none;" class="btn-update btn btn-primary btn-xs" id="upCity_<?php echo e($city->id); ?>"><i class="fa fa-save">&nbsp;<?php echo e(trans('common.save')); ?></i></a>
						        					&nbsp; | &nbsp;
						        					<a href="javascript:;" class="btn-refresh btn btn-info btn-xs" id="refresh_<?php echo e($city->id); ?>"><span class="fa fa-refresh" title="Refresh"></span></a>
						                  			&nbsp; | &nbsp;
						                  			<?php if($city->status==1): ?>
						        					 <a href="javascript:;" class="btn btn-warning btn-xs" onclick="inactiveConfirm('<?php echo e($city->id); ?>')" id="cityId<?php echo e($city->id); ?>"><i class="fa fa-ban">&nbsp;<?php echo e(trans('common.inactive')); ?></i></a>
						                  			<?php else: ?>
						                    		<a href="javascript:;" class="btn btn-success btn-xs" onclick="activeConfirm('<?php echo e($city->id); ?>')" id="cityId<?php echo e($city->id); ?>"><span class="fa fa-check-square-o"> <?php echo e(trans('common.active')); ?></i></a>
						                  			<?php endif; ?>
						    					</td>
											</tr>
											<?php endforeach; ?>
						    ...
						    <div role="tabpanel" class="tab-pane" id="addCity">
						    	<?php echo Form::open(array('route'=>'city.post','class'=>'form-horizontal form-wrp cityForm','files'=>true)); ?>

								<div class="form-group">
									<label class="col-md-2"> <?php echo e(trans('basicSetup.city_name_en')); ?> </label>
									<div class="col-md-3">
										<input type="text" class="form-control" name="city_name_lang1" placeholder="Ex: Dhaka...">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2"> <?php echo e(trans('basicSetup.city_name_bn')); ?></label>
									<div class="col-md-3">
										<input type="text" class="form-control" name="city_name_lang2" placeholder="উদাঃ ঢাকা...">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2"> <?php echo e(trans('basicSetup.city_wise_cost')); ?></label>
									<div class="col-md-3">
...
//======@@ Save btn function @@========
	...
	$('.btn-update').on('click', function(){
		...
		$.ajax({
			url      : "<?php echo e(URL::to('saveEditCity')); ?>",
			type     : "GET",
			cache    : false,
			dataType : 'json',
	...
	$.ajax({
	    ...
	    success : function(data){
		    if(data.success == true){
				...
				$("#cityId"+id).html('<a href="javascript:;" class="btn btn-success btn-xs" onclick="activeConfirm('+id+')" id="cityId'+id+'"><span class="fa fa-check-square-o">&nbsp;<?php echo e(trans("common.active")); ?></span></a>'); //inactive hide
	  	...
	  	success : function(data){
		  	if(data.success == true){
				...
				info_suc.delay(3000).slideUp(300);
			 	...
			 	$("#cityId"+id).html('<a href="javascript:;" class="btn btn-warning btn-xs" onclick="inactiveConfirm('+id+')" id="cityId'+id+'"><span class="fa fa-ban">&nbsp;<?php echo e(trans("common.inactive")); ?></span></a>'); //active hide
