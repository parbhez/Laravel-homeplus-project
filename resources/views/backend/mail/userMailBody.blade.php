...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
	...
	<tr>
		<td align="left" valign="top" width="100%" style="background: red;">
			<center>
								...
								<table cellpadding="0" cellspacing="0" width="600" class="w320">
									<tr>
										<td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
											<a href=""><img width="137" height="47" src="{{URL::to('public/frontend/assets/img/logo.png')}}" alt="logo"></a>
										</td>
		...
		<td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
			<center>
				<table cellspacing="0" cellpadding="0" width="600" class="w320">
					...
					<tr>
						<td class="free-text">
							We wanted to let you know that we just shipped off your order <a href="">#{{$order->master_invoice_no}}</a>. You'll find all the details below.
						</td>
					</tr>
					{{--<tr>--}}
						{{--<td class="button">--}}
					...
					<tr>
						<td class="item-table">
							<table cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td class="title-dark" width="200">Item</td>
									<td class="title-dark" width="100">Unit Price</td>
									<td class="title-dark" width="163">Qty</td>
									<td class="title-dark" width="97">Total</td>
								</tr>
								@if (isset($orderArr))
									<?php $i= 1;$shipmentCost = $payable = $discount = 0;  ?>
									@foreach($orderArr as $order)
											<tr>
												<td class="item-col item">
													<span style="color: #4d4d4d; font-weight: bold;">Pink Shoes</span> <br />
													{{$order->product_name_lang1}}
												</td>
										...
										<?php
										$shipmentCost = $order->shipping_cost;
										$discount    += $order->discount;
										$discount    += $order->vat;
										$payable     += ($order->sale_price + $order->vat) - $order->discount;
										?>
									@endforeach
								@endif
								<tr>
									...
									<td class="item-col quantity" style="text-align:right; padding-right: 10px; border-top: 1px solid #cccccc;">
										<span class="total-space">Shipment Cost</span> <br />
										<span class="total-space">Total Discount</span>  <br />
										<span class="total-space" style="font-weight: bold; color: #4d4d4d">Total</span>
									</td>
									<td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
										<span class="total-space">{{$shipmentCost}}</span> <br />
										<span class="total-space">{{$discount}}</span>  <br />
										<span class="total-space" style="font-weight:bold; color: #4d4d4d">{{$payable + $shipmentCost}}</span>
									</td>
								</tr>
							</table>
						</td>
