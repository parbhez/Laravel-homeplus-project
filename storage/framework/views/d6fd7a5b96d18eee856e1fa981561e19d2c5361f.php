<?php $__env->startSection('main_container'); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php if(count($subCategory) > 0): ?>
                            <?php if(! empty($subCategory->featured_image)): ?>
                        ...
                        <div class="product_title_and_list">
                            ...
                            <div class="sub_category_list">
                                <ul class="list-inline">
                                    <li>
                                        <p><?php echo e(trans('frontend.sub_category')); ?></p>
                                    </li>
    ...
    <script>
        ...
        function loadContent(subSubCategoryId,startRange,endRange) {
            var subCategoryId = "<?php if(isset($subCategory)): ?><?php echo e($subCategory->id); ?><?php endif; ?>";
            if (!subCategoryId){
            ...
            $.ajax({
                url  : "<?php echo e(URL::to('subCategoryWiseProductLoad')); ?>",
                type : 'GET',
                dataType : 'json',
