...
window.MagicZoom = (function() {
    ...
    var s = function() {
        return "mgctlbxN$MZ" + "".toUpperCase() + " mgctlbxV$" + "v5.1.14".replace("v", "") + " mgctlbxL$" + "t".toUpperCase() + ((window.mgctlbx$Pltm && "string" == z.jTypeOf(window.mgctlbx$Pltm)) ? " mgctlbxP$" + window.mgctlbx$Pltm.toLowerCase() : "")
    };
