       ...
       <div class="right-all-product">
          ...
          <div class="product-category-title">
             ...
             <h1>
                ...
                <span class="count-product">Total products&nbsp;17</span>
             </h1>
                      ...
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/apple-watch.htm">
                               <img src="public/frontend/assets/images/baby1.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#apple-watch"><i class="fa fa-search"></i></a></li>
                                     <li>
                                     ...
                                     <li><a href="all.htm#" title="Copare"><i class="fa fa-retweet"></i></a></li>
                                     <li><a class="wishlist-login" href="all.htm#"><i class="fa fa-heart-o"></i></a></li>
                                  </ul>
                               </div>
                            </div>
                            <div class="product-info">
                               ...
                               <a href="../products/apple-watch.htm">Apple watch</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/baby-dress.htm">
                               <img src="public/frontend/assets/images/baby2.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#baby-dress"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="../products/baby-dress.htm">baby dress</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/baby-watch.htm">
                               <img src="public/frontend/assets/images/baby3.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#baby-watch"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="../products/baby-watch.htm">baby watch</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/digital-watch.htm">
                               <img src="public/frontend/assets/images/baby4.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#digital-watch"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="../products/digital-watch.htm">Digital Watch</a>
                               <div class="price-box">
                                  <span class="price">Tk 200.00</span>
                                  <span class="visually-hidden">translation missing: en.cart.general.regular_price</span>
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/gary-summer-shoes.htm">
                               <img src="public/frontend/assets/images/men1.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#gary-summer-shoes"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="../products/gary-summer-shoes.htm">gary summer shoes</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/high-quality-watch.htm">
                               <img src="public/frontend/assets/images/men2.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#high-quality-watch"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="../products/high-quality-watch.htm">high quality watch</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/leather-man-wacth.htm">
                               <img src="public/frontend/assets/images/men3.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="all.htm#" title="Quick View" data-toggle="modal" data-target="#leather-man-wacth"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="../products/leather-man-wacth.htm">leather man wacth</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="../products/leather-women-bag.htm">
                               <img src="public/frontend/assets/images/men4.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sold Out</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="http://bstore-8.myshopify.com/collections/all.htm#" title="Quick View" data-toggle="modal" data-target="#leather-women-bag"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                                     ...
                                     <li><a href="http://bstore-8.myshopify.com/collections/all.htm#" title="Copare"><i class="fa fa-retweet"></i></a></li>
                                     <li><a class="wishlist-login" href="http://bstore-8.myshopify.com/collections/all.htm#"><i class="fa fa-heart-o"></i></a></li>
                                  </ul>
                               </div>
                            </div>
                            <div class="product-info">
                               ...
                               <a href="http://bstore-8.myshopify.com/products/leather-women-bag.htm">leather women bag</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="http://bstore-8.myshopify.com/products/luxury-watch.htm">
                               <img src="public/frontend/assets/images/sale1.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="http://bstore-8.myshopify.com/collections/all.htm#" title="Quick View" data-toggle="modal" data-target="#luxury-watch"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="http://bstore-8.myshopify.com/products/luxury-watch.htm">Luxury watch</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="http://bstore-8.myshopify.com/products/men-shoes.htm">
                               <img src="public/frontend/assets/images/sale2.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="http://bstore-8.myshopify.com/collections/all.htm#" title="Quick View" data-toggle="modal" data-target="#men-shoes"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="http://bstore-8.myshopify.com/products/men-shoes.htm">Men shoes</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="http://bstore-8.myshopify.com/products/short-selve-t-shirt.htm">
                               <img src="public/frontend/assets/images/sale3.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="http://bstore-8.myshopify.com/collections/all.htm#" title="Quick View" data-toggle="modal" data-target="#short-selve-t-shirt"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="http://bstore-8.myshopify.com/products/short-selve-t-shirt.htm">Mohilader hill</a>
                               <div class="price-box">
                ...
                <li class="category-product-list col-lg-3 col-md-4 col-sm-6 col-xs-12">
                   <div class="item">
                      <div class="product-width">
                         <div class="single-product-item">
                            <div class="product-image">
                               <a href="http://bstore-8.myshopify.com/products/printed-summer-t-shirt.htm">
                               <img src="public/frontend/assets/images/sale4.jpeg" alt="Apple watch">
                               </a>
                               <span class="new-mark-box">Sale</span>
                               <div class="overlay-content">
                                  <ul>
                                     <li><a href="http://bstore-8.myshopify.com/collections/all.htm#" title="Quick View" data-toggle="modal" data-target="#printed-summer-t-shirt"><i class="fa fa-search"></i></a></li>
                                     <li>
                                        <form action="http://bstore-8.myshopify.com/cart/add" method="post" class="variants" enctype="multipart/form-data" style="padding:0px;">
                                           <select name="id" style="display:none;">
                            ...
                            <div class="product-info">
                               ...
                               <a href="http://bstore-8.myshopify.com/products/printed-summer-t-shirt.htm">Printed Summer T-Shirt</a>
                               <div class="price-box">
             ...
             <div class="product-shooting-bar product-shooting-bar-bottom">
                <div class="pagination">
                   <ul class="pagination-custom">
                      ...
                      <li>
                         <a href="http://bstore-8.myshopify.com/collections/all_2.htm" title="">2</a>
                      </li>
                      <li class="next"><a href="http://bstore-8.myshopify.com/collections/all_2.htm" title="Next &raquo;">&rarr;</a></li>
                   </ul>
                </div>
             </div>
          </div>
