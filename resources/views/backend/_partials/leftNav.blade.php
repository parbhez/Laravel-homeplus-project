    ...
    <div id="mainnav">
        <ul class="mainnav"> <!-- NOTE TO READER: Accepts the following class(es) "animate" class -->
            <li class="menu-item-top">
                <a href="{{URL::to('dashboard')}}" class="top">
            ...
            <li class="menu-item-top">
                ...
                <ul>
                    ...
                    <li><a href="{{URL::to('subCategory')}}">Sub Category</a></li>
                    <li><a href="{{URL::to('subCategoryDetails')}}">Sub Category Details</a></li>
                    <li><a href="{{URL::to('color')}}">Color</a></li>
                    <li><a href="{{URL::to('size')}}">Size</a></li>
                    <li><a href="{{URL::to('city')}}">City</a></li>
                </ul>
            </li>
            <li class="menu-item-top">
                <a href="{{URL::to('photoSlider')}}" class="top">
								<span class="main-menu-icon">
            ...
            <!-- <li class="menu-item-top">
                <a href="{{URL::to('merchant')}}" class="top">
								<span class="main-menu-icon">
									<span aria-hidden="true" class="icon icon-layers"></span>
								</span>
            ...
            <li class="menu-item-top">
                <a href="{{URL::to('product')}}" class="top">
								<span class="main-menu-icon">
            ...
            <li class="menu-item-top">
                <a href="{{URL::to('orders')}}" class="top">
								<span class="main-menu-icon">
									<span aria-hidden="true" class="icon icon-star"></span>
								</span>
            ...
            <!-- <li class="menu-item-top">
                <a href="{{URL::to('report')}}" class="top">
								<span class="main-menu-icon">
									<span aria-hidden="true" class="icon icon-star"></span>
								</span>
