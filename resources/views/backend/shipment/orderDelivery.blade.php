        	...
        	<div class="box_header">
            	<span>
					...
					<span class="main-text">
						{{trans('dashboard.order_delivery')}}
					</span>
			    </span>
            </div>	
				...
				<div class="block-content-outer">
					...
					<!-- =======Start Page Content======= -->
						...
						<table  class="table table-bordered" width="100%">
									...
									<tbody>
									@if(isset($deliveryOrders))
										@forelse($deliveryOrders as $data)
										<tr>
											...
											<td class="">
						        				...
						        				<a href="javascript:;" class="btn btn-warning btn-xs" id="returnDelivery_{{$data->id }}" onclick="returnDelivery({{ $data->id }})"><span class="fa fa-ban"> Delivery Return</span></a>
											</td>
										</tr>
										@empty
									 	@endforelse
		...
		$.ajax({
		  ...
		  success : function(data){
		    ...
		    if(data.success == true){
			    ...
			    $("#returnDelivery_"+id).parent().prev().html("<label class='label label-warning'>Deny</label>");
			    $("#returnDelivery_"+id).parent().parent().hide(2000);
			}
		    else{
		    	$('.info-error').slideDown().delay(500).slideUp();
		    }
